...
from be.constants import Tclean
from be.constants import Tcleanall
from be.constants import Tconfigure
...
class BEParser:
    ...
    def configure(self):
        ...
        subparsers = self._parser.add_subparsers(help='build targets', dest='target')
        #
        # Sub-parsers for sub-commands like 'clean', 'cleanall',
        # 'configure', 'dev', 'test', 'release' and 'prelease'
        parser_clean     = subparsers.add_parser(Tclean,     help=help_clean)
        parser_cleanall  = subparsers.add_parser(Tcleanall,  help=help_cleanall)
        parser_configure = subparsers.add_parser(Tconfigure, help=help_configure)
        parser_dev       = subparsers.add_parser(Tdev,       help=help_dev)
        parser_test      = subparsers.add_parser(Ttest,      help=help_test)
        parser_release   = subparsers.add_parser(Trelease,   help=help_release)
        parser_prelease  = subparsers.add_parser(Tprelease,  help=help_prelease)
        #
...
if __name__ == '__main__':
    print '\t\t-----------------------------------------------'
    print '\t\tNOTE: You are not suppose to run this file'
    print '\t\t      like this! however, the following is'
    print '\t\t      the help!!! ;)'
    print '\t\t-----------------------------------------------'
    p = BEParser()
    p.help()
